...
<body>
    ...
    <div class="body_wrapper">
        <div class="sidemenu" id="mySidebar">
            <ul>
                ...
                <li class="dropdown active">
                    ...
                    <ul>
                        <li><a href="#"><span class="icon"><i class="fa fa-user"></i></span><span>Sponser</span></a></li>
        ...
        <form action="sponser.php" method="POST">
            ...
            <div class="search">
            <!-- <Strong style="font-size: 23px"> Sponser </Strong> -->
                ...
                <button type="submit" name="searchsubmit" class="searchButton">
                 ...
                 <a class="globe" href="sponser.php?pos=9999"><i class="fa fa-globe"></i></a>
              
              <!-- <div class="navi"> -->
                  <?php
                          $sql = "SELECT * from `register` WHERE  `user_type`='Sponser'";// where `verified`='1' AND `status`='1'";
              ...
              <?php if($pos>0){?>
              <a class="navileft" href="sponser.php?pos=<?php echo $pos-10;?>"><i class="fa fa-chevron-left"></i></a>
              <?php }else { ?>
              <a class="navileft"><i class="fa fa-chevron-left"></i></a>
              <?php } if(($pos+10)<$total){ ?>
              <a class="naviright" href="sponser.php?pos=<?php echo $pos+10;?>"><i class="fa fa-chevron-right"></i></a>
              <?php } else { ?>
    ...
    <?php
     ...
     if($conn-> connect_error){
         ...
         if($search==1){
             $sql = "SELECT * from register WHERE `user_type`='Sponser' AND `firstname`='$search_name' ";
         }else{
         $sql = "SELECT * from register WHERE `user_type`='Sponser' AND 1 Limit $pos, $pos10";
         }
