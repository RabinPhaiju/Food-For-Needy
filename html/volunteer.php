...
<?php include 'navbar1.html';?>
    ...
    <?php include 'navbar2.html';?>
        ...
        <caption><b style="font-size:25px;">Food For Needy - Volunteers</b></caption>
        <br>
        <form action="volunteer.php" method="POST">
       
            <div class="search">
            <!-- <Strong style="font-size: 23px"> Volunteer </Strong> -->
                ...
                <button type="submit" name="searchsubmit" class="searchButton">
                 ...
                 <a class="globe" href="volunteer.php?pos=9999"><i class="fa fa-globe"></i></a>
              ...
              <?php if($pos>0){?>
              <a class="navileft" href="volunteer.php?pos=<?php echo $pos-10;?>"><i class="fa fa-chevron-left"></i></a>
              <?php }else { ?>
              <a class="navileft"><i class="fa fa-chevron-left"></i></a>
              <?php } if(($pos+10)<$total){ ?>
              <a class="naviright" href="volunteer.php?pos=<?php echo $pos+10;?>"><i class="fa fa-chevron-right"></i></a>
              <?php } else { ?>
    ...
    <?php
     ...
     if($conn-> connect_error){
         ...
         if($search==1){
             $sql = "SELECT * from register WHERE `user_type`='Volunteer' AND `firstname`='$search_name' ";
         }else{
         $sql = "SELECT * from register WHERE `user_type`='Volunteer' AND 1 Limit $pos, $pos10";
         }
