(function () {
    ...
    showPage=function (pageName, cb) {
        ...
        if ($prevPage.length > 0) {
            // Slide out old
            tl.to($prevPage, 0.5, {
                x: 800, ease: Power3.easeIn, clearProps: "scale", onComplete: function () {
        ...
        tl.from($page, 0.5, {
            scale: 0.6, delay: 0.2, ease: Power3.easeOut, onStart: function () {
                return $page.show();
            }
        }
        );
        ...
        if (pageName==="home") {
            ...
            tl.staggerFrom(".page-home .panel-functions .icon", 1.5, {
                y: 150, clearProps: "opacity, scale", ease: Elastic.easeOut
            }
            , 0.2, "-=0.4");
        ...
        if (pageName==="weather") {
            ...
            tl.staggerFrom(".page-weather .panel-forecast .box", 1.2, {
                y: 150, delay: 0.5, ease: Elastic.easeOut
            }
            , 0.1, "-=0.5");
        }
        ...
        if (pageName==="calendar") {
            tl.staggerFrom(".page-calendar .panel-calendar", 1.0, {
                y: -150, autoAlpha: 0, ease: Power3.easeOut
            }
            , 0.3);
    ...
    $(function () {
        ...
        $('.page').each(function (i, page) {
            ...
            type="pan";
            mc.get(type).set( {
                direction: Hammer.DIRECTION_HORIZONTAL, threshold: 10
            }
            );
        ...
        $(".page-home .panel-functions .icon").on("click", function () {
            TweenLite.to($(this), 0.5, {
                scale: 2.0, clearProps: "opacity, scale", opacity: 0
            }
            );
        ...
        return setInterval(function () {
            ...
            li=$(`.page-news .panel-newslist-small li:eq($ {
                smallIndex
            }
            )`);
            top=li.offset().top;
    ...
    showMap=function () {
        ...
        mapOptions= {
            center: {
                lat: 47.480865, lng: 19.060265
            }
            , zoom: 12, // Cobalt Theme
            styles: [ {
